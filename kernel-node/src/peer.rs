...
impl BitcoinPeer {
    pub fn new(
        ...
        let conf = ConnectionConfig::new()
            ...
            // TODO 1: add custom user agent e.g your name
            // This helps your peer in identifying the software you are running and which version
            // e.g (Bitcoin Core v30 :), btcd, Knots, .)
            .user_agent(UserAgent::from_nonstandard("")); // user agent goes inside this
        // quoted string
        ...
        // TODO 2: send the initial message to your peer requesting blocks if he has any.
        // hint look at writer
